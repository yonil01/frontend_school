...
export class ChangePasswordComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder, private SubjectService: SubjectsService,) {
  ...
  public saveForm():void {
    if (this.formPassword.valid) {
      if (this.comparePassword()) {
        ...
        this.SubjectService.updatePasswordByAdministrator(
          this.Subject?.dni!.toLowerCase(),
          password,
          passpasswordConfirm,
        ).subscribe(
          (response: Response) => {
