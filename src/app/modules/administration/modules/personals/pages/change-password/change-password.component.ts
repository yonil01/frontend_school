...
export class ChangePasswordComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder, private PersonalService: PersonalsService,) {
  ...
  public saveForm():void {
    if (this.formPassword.valid) {
      if (this.comparePassword()) {
        ...
        this.PersonalService.updatePasswordByAdministrator(
          this.Personal?.dni!.toLowerCase(),
          password,
          passpasswordConfirm,
        ).subscribe(
          (response: Response) => {
