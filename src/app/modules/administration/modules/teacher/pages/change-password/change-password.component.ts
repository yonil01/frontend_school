...
export class ChangePasswordTeacherComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder, private Teacherervice: TeacherService,) {
  ...
  public saveForm():void {
    if (this.formPassword.valid) {
      if (this.comparePassword()) {
        ...
        this.Teacherervice.updatePasswordByAdministrator(
