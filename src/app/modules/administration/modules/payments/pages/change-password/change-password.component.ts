...
export class ChangePasswordComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder, private PaymentService: PaymentsService,) {
  ...
  public saveForm():void {
    if (this.formPassword.valid) {
      if (this.comparePassword()) {
        ...
        this.PaymentService.updatePasswordByAdministrator(
          this.Payment?.dni!.toLowerCase(),
          password,
          passpasswordConfirm,
        ).subscribe(
          (response: Response) => {
