...
@Component({
  selector: 'app-key-word-multiple-values',
  templateUrl: './key-word-multiple-values.component.html',
  styleUrls: ['./key-word-multiple-values.component.scss'],
  providers: [],
})
export class KeyWordMultipleValuesComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    console.log(this.observableGetEntities)
