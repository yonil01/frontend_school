...
export const controlEntities = createAction('[Entity] load entities', props<{ entities: Entity[] }>());

export const controlEntity = createAction('[Entity] load entity', props<{ entity: Entity; index: number }>());

export const showEntity = createAction('[Entity] show entity', props<{ operation: string }>());

export const editEntity = createAction('[Entity] edit entity', props<{ entity: Entity }>());

export const addEntity = createAction('[Entity] add entity', props<{ entity: Entity }>());
