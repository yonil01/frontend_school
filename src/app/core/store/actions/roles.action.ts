...
export const addDatedisallowed = createAction(
  ...
  props<{ datedisallowed: DateDisallowed }>(),
);
...
export const addPasswordPolicy = createAction('[role] add passwordpolicy', props<{ passwordpolicy: PasswordPolicy }>());

export const deletePasswordPolicy = createAction('[PasswordPolicy] delete passwordpolicy', props<any>());

// Element
export const addElement = createAction('[role] add element', props<{ element: Elements }>());
...
export const addSecurityEntities = createAction(
  ...
  props<{ securityEntities: SecurityEntity }>(),
);

export const editSecurity = createAction('[SecurityEntities] edit security', props<{ securityEntities: RoleAttribute }>());
...
// Agregar roleAllow
export const addRoleAllow = createAction('[RoleAllowed] add roleallow', props<{ rolleallow: RoleAllowed[] }>());
...
export const updateAtrribute = createAction(
  ...
  props<{ attribute: RoleAttribute; indexRoleAtribu: number }>(),
);
