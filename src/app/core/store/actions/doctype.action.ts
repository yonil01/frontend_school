...
export const controlDoctype = createAction('[DocTypes] load doctype', props<{ docType: DocTypes; indexDocType: number }>());

// Acciones Doctype
export const addDoctype = createAction('[DocTypes] add doctype', props<{ doctype: DocTypes }>());
export const editDoctype = createAction('[DocTypes] edit doctype', props<{ doctype: DocTypes }>());
...
export const controlDoctypes = createAction(
    ...
    props<{ docType: DocTypes; indexDocType: number; operation: string }>());
...
export const controlAutoname = createAction('[DocTypes] load autoname', props<{ autoname: DocTypes []}>());
...
export const controlEntity = createAction('[DoctypeEntities] load entity', props<{ docEntity: DocTypes []}>());
